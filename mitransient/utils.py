...
YEO_JOHNSON_TRANSFORMATION = 0
BOX_COX_TRANSFORMATION = 1
...
def cornell_box():
    ...
    return {
        ...
        "sensor": {
            ...
            "fov": 39.3077,
            "to_world": T().look_at(
                origin=[0, 0, 3.90], target=[0, 0, 0], up=[0, 1, 0]
            ),
        ...
        "light": {
            "type": "rectangle",
            "to_world": T()
            .translate([0.0, 0.99, 0.01])
            .rotate([1, 0, 0], 90)
            .scale([0.23, 0.19, 0.19]),
